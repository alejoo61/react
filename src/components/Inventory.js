                ...
                <div className="row row-cols-1 row-cols-md-3 g-4">
                    <div className="col">
                        <div class="card mb-3 w-100 bg-transparent border-0">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="/img/Comun.png" class="img-fluid rounded-start border border-3 border-warning" alt="..." />
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body text-white">
                                        <h5 class="card-title">Cofre Comun</h5>
                    ...
                    <div className="col">
                        <div class="card mb-3 w-100 bg-transparent border-0">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="/img/cristal de batalla.png" class="img-fluid rounded-start border border-3 border-warning" alt="..." />
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body text-white">
                                        <h5 class="card-title">Cristal de Crianza</h5>
                                        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                        <div className="card-body">
                                            <p className='card-text'>PRICE <span> 0</span></p>
                                            <p class="card-text">STOCK<span> 0</span></p>
                                            <button className='btn btn-primary me-5'> BUY</button>
                                        </div>
                    ...
                    <div className="col">
                        <div class="card mb-3 w-100 bg-transparent border-0">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="/img/cristal de Crianza.png" class="img-fluid rounded-start border border-3 border-warning" alt="..." />
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body text-white">
                                        <h5 class="card-title">Cristal de Crianza</h5>
                    ...
                    <div className="col">
                        <div class="card mb-3 w-100 bg-transparent border-0">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="/img/cristal del olvido.png" class="img-fluid rounded-start border border-3 border-warning" alt="..." />
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body text-white">
                                        <h5 class="card-title">Cristal del Olvido</h5>
                                        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                        <div className="card-body">
                                            <p className='card-text'>PRICE <span> 0</span></p>
                                            <p class="card-text">STOCK<span> 0</span></p>
                    ...
                    <div className="col">
                        <div class="card mb-3 w-100 bg-transparent border-0">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="/img/cristal del tiempo.png" class="img-fluid rounded-start border border-3 border-warning" alt="..." />
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body text-white">
                                        <h5 class="card-title">Cristal del Tiempo</h5>
                                        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                        <div className="card-body">
                                            <p className='card-text'>PRICE <span> 0</span></p>
                                            <p class="card-text">STOCK<span> 0</span></p>
                    ...
                    <div className="col">
                        <div class="card mb-3 w-100  bg-transparent border-0">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="/img/cristal de Fusion.png" class="img-fluid rounded-start border border-3 border-warning" alt="..." />
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body text-white">
                                        <h5 class="card-title">Cristal de Fusion</h5>
                                        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                        <div className="card-body">
